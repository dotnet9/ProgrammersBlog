...
public class CommentController : BaseController
{
	...
	public CommentController(UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper,
		ICommentService commentService) : base(userManager, mapper, imageHelper)
	{
