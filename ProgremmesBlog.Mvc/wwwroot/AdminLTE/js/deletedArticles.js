                            ...
                            if (articleResult.Data.ResultStatus === 0) {
                                ...
                                $.each(articleResult.Data.Articles.$values,
                                    function(index, article) {
                                        const newArticle = getJsonNetObject(article,
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            newCategory.Name,
                                            newArticle.Title,
                                            `<img src="/img/${newArticle.Thumbnail}" alt="${newArticle.Title
                                            }" class="my-image-table" />`,
                                            `${convertToShortDate(newArticle.Date)}`,
                                            newArticle.ViewCount,
                                            newArticle.CommentCount,
                                            `${newArticle.IsActive ? "是" : "否"}`,
                                            `${newArticle.IsDeleted ? "是" : "否"}`,
                                            ...
                                            `
                                <button class="btn btn-primary btn-sm btn-undo" data-id="${newArticle.Id
    ...
    $(document).on("click",
        ...
        function(event) {
            ...
            Swal.fire({
                ...
                text: `${articleTitle} 标题lı makale kalıcı olarak silinicektir!`,
                icon: "warning",
    ...
    $(document).on("click",
        ...
        function(event) {
            ...
            Swal.fire({
                ...
                text: `${articleTitle} 标题lı makale arşivden geri getirilecektir!`,
                icon: "question",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
