                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                                <tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                                                    ...
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.IsActive
                            ? "是"
                            : "否"}</td>
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.IsDeleted
                            ? "是"
                            : "否"}</td>
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.Note}</td>
                                                    <td>${convertToShortDate(categoryAddAjaxModel.CategoryDto.Category
                                .CreatedDate)}</td>
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.CreatedByName}</td>
                                                    <td>${convertToShortDate(categoryAddAjaxModel.CategoryDto.Category
                                .ModifiedDate)}</td>
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category
                            .ModifiedByName}</td>
                                                    <td>
                                                        <button class="btn btn-primary btn-sm btn-update" data-id="${
                            categoryAddAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-edit"></span></button>
                ...
                $.post(actionUrl, dataToSend).done(function(data) {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                            ...
                            .CategoryDto.Category.IsActive
                            ? "是"
                            : "否"}</td>
                                                    <td>${categoryUpdateAjaxModel
                            .CategoryDto.Category.IsDeleted
                            ? "是"
                            : "否"}</td>
