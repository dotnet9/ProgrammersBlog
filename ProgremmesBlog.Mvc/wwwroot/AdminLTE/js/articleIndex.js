                                ...
                                $.each(articleResult.Data.Articles.$values,
                                    function(index, article) {
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            `
                                <a class="btn btn-primary btn-sm btn-update" href="/Admin/Article/Update?articleId=${
                                            newArticle.Id}"><span class="fas fa-edit"></span></a>
    ...
    $(document).on("click",
        ...
        function(event) {
            ...
            Swal.fire({
                ...
                text: `${articleTitle} 标题lı makale silinicektir!`,
                icon: "warning",
