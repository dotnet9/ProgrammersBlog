                ...
                $.post(actionUrl, dataToSend).done(function(data) {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = dataTable.row.add([
                            ...
                            categoryAddAjaxModel.CategoryDto.Category.IsActive ? "是" : "否",
                            categoryAddAjaxModel.CategoryDto.Category.IsDeleted ? "是" : "否",
                            ...
                            `
                                <button class="btn btn-primary btn-sm btn-update" data-id="${categoryAddAjaxModel
                            .CategoryDto.Category.Id}"><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete" data-id="${categoryAddAjaxModel
                ...
                $.post(actionUrl, dataToSend).done(function(data) {
                    ...
                    if (isValid) {
                        ...
                        dataTable.row(tableRow).data([
                            ...
                            categoryUpdateAjaxModel.CategoryDto.Category.IsActive ? "是" : "否",
                            categoryUpdateAjaxModel.CategoryDto.Category.IsDeleted ? "是" : "否",
